...
def get_quoting_options(
    ...
    if shell_type in vscode_task_runner_old.constants.DEFAULT_SHELL_QUOTING:
        shell_config.quoting = vscode_task_runner_old.constants.DEFAULT_SHELL_QUOTING[
            shell_type
        ]
    else:
        shell_config.quoting = vscode_task_runner_old.constants.DEFAULT_OS_QUOTING[
            vscode_task_runner_old.constants.PLATFORM_KEY
        ]
...
def build_shell_command_line(
    ...
    if vscode_task_runner_old.constants.PLATFORM_KEY == "windows":
